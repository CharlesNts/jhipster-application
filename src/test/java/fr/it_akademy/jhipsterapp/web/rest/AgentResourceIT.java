...
class AgentResourceIT {
    ...
    public static Agent createEntity(EntityManager em) {
        Agent agent = new Agent().lastname(DEFAULT_LASTNAME).firstname(DEFAULT_FIRSTNAME).age(DEFAULT_AGE);
        return agent;
    }
    ...
    public static Agent createUpdatedEntity(EntityManager em) {
        Agent agent = new Agent().lastname(UPDATED_LASTNAME).firstname(UPDATED_FIRSTNAME).age(UPDATED_AGE);
        return agent;
    }
    ...
    void createAgent() throws Exception {
        ...
        assertThat(testAgent.getAge()).isEqualTo(DEFAULT_AGE);
    }
    ...
    void putExistingAgent() throws Exception {
        ...
        updatedAgent.lastname(UPDATED_LASTNAME).firstname(UPDATED_FIRSTNAME).age(UPDATED_AGE);
        ...
        assertThat(testAgent.getAge()).isEqualTo(UPDATED_AGE);
    }
    ...
    void partialUpdateAgentWithPatch() throws Exception {
        ...
        partialUpdatedAgent.firstname(UPDATED_FIRSTNAME).age(UPDATED_AGE);
    ...
    void fullUpdateAgentWithPatch() throws Exception {
        ...
        partialUpdatedAgent.lastname(UPDATED_LASTNAME).firstname(UPDATED_FIRSTNAME).age(UPDATED_AGE);
