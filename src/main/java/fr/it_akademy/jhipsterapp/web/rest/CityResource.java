...
/**
 * REST controller for managing {@link fr.it_akademy.jhipsterapp.domain.City}.
 */
@RestController
...
public class CityResource {
     ...
     */
    @GetMapping("")
    public List<CityDTO> getAllCities(@RequestParam(required = false) String filter) {
        if ("agent-is-null".equals(filter)) {
            log.debug("REST request to get all Citys where agent is null");
            return cityService.findAllWhereAgentIsNull();
        }
